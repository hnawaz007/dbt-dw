...
with DAG(dag_id='airbyte_sync_airflow_dag',
  ...
  # our trigger task
#    trigger_dbt_task: TriggerDagRunOperator = TriggerDagRunOperator(dag=dag,
#                                                                 task_id='trigger_dbt',
#                                                                 trigger_rule=TriggerRule.ALL_SUCCESS,
#                                                                 trigger_dag_id= 'dbt_operator_dag')
    # our trigger task should run when all 'tail' tasks have completed / succeeded

   trigger_airbyte_sync >> wait_for_sync_completion >> merge_product #>> trigger_dbt_task